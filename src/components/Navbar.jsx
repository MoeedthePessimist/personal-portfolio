...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile drawer — rendered OUTSIDE <nav> so it never inherits
          the nav's backdrop-blur or background, regardless of scroll state */}
      <AnimatePresence>
        {isOpen && (
          <>
            {/* Backdrop overlay */}
            ...
            <motion.div
              ...
              className="lg:hidden fixed top-0 right-0 h-full w-72 bg-bg-card border-l border-white/8 flex flex-col p-8 pt-20 shadow-2xl z-[70]"
            >
              <button
